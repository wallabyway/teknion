...
var materials = {
    ...
    methods: {
        setFabric: function(textureName) {
            this.setPrism149(textureName, [9,15]);
            //const mat = viewer.impl.matman()._materials["model:1|mat:3"];
            //this.setDiffuseTexture(mat, textureName);
        },

        setFrame: function(color, color2, cost) {
            const mat = viewer.impl.matman()._materials["model:1|mat:0"];
            mat.metal_f0.set(color);
            const mat2 = viewer.impl.matman()._materials["model:1|mat:1"];
            mat2.opaque_albedo.set(color2);
            //this.setPrism252(textureName, [5, 7, 8, 11, 14, 24, 26, 28]);
        ...
        setDiffuseTexture: function(mat, textureName) {
            mat.opaque_albedo_map = THREE.ImageUtils.loadTexture(`img/textures/${textureName}`, null, i => {
                viewer.impl.invalidate(true, true);
            });
        ...
        setPrism252: function(textureName, dbIds) {}, //textured plastic
        ...
        setPrism149: function(textureName, dbIds) {
            ...
            function set3MaterialToFrags(fragIds) {
                ...
                var material = matmgr._materials[textureName];
                fragIds.map(fragId =>
